...
# -*- coding: utf-8 -*-
'''
    File name: constrained_permutations\solution__631.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #631 :: Constrained Permutations
# 
