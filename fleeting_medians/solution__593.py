...
# -*- coding: utf-8 -*-
'''
    File name: fleeting_medians\solution__593.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #593 :: Fleeting Medians
# 
