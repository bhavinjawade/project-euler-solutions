...
# -*- coding: utf-8 -*-
'''
    File name: poohsticks_marathon\solution__589.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #589 :: Poohsticks Marathon
# 
