...
# -*- coding: utf-8 -*-
'''
    File name: binary_quadratic_form\solution__586.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #586 :: Binary Quadratic Form
# 
