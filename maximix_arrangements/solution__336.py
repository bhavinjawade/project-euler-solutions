...
# -*- coding: utf-8 -*-
'''
    File name: maximix_arrangements\solution__336.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #336 :: Maximix Arrangements
# 
