...
# -*- coding: utf-8 -*-
'''
    File name: restricted_factorisations\solution__636.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #636 :: Restricted Factorisations
# 
