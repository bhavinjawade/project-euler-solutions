...
# -*- coding: utf-8 -*-
'''
    File name: digital_root_clocks\solution__315.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #315 :: Digital root clocks
# 
