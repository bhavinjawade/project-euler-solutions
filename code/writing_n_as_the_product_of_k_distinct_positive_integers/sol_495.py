...
# -*- coding: utf-8 -*-
'''
    File name: code\writing_n_as_the_product_of_k_distinct_positive_integers\sol_495.py
    Author: Vaidic Joshi
    Date created: Oct 20, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #495 :: Writing n as the product of k distinct positive integers
# 
