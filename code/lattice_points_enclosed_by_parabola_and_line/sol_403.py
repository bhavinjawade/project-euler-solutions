...
# -*- coding: utf-8 -*-
'''
    File name: code\lattice_points_enclosed_by_parabola_and_line\sol_403.py
    Author: Vaidic Joshi
    Date created: Oct 20, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #403 :: Lattice points enclosed by parabola and line
# 
