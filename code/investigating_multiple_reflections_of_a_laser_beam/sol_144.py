...
# -*- coding: utf-8 -*-
'''
    File name: code\investigating_multiple_reflections_of_a_laser_beam\sol_144.py
    Author: Vaidic Joshi
    Date created: Oct 20, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #144 :: Investigating multiple reflections of a laser beam
# 
