...
# -*- coding: utf-8 -*-
'''
    File name: code\distance_of_random_points_within_hollow_square_laminae\sol_547.py
    Author: Vaidic Joshi
    Date created: Oct 20, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #547 :: Distance of random points within hollow square laminae
# 
