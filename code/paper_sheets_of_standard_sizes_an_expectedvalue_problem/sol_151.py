...
# -*- coding: utf-8 -*-
'''
    File name: code\paper_sheets_of_standard_sizes_an_expectedvalue_problem\sol_151.py
    Author: Vaidic Joshi
    Date created: Oct 20, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #151 :: Paper sheets of standard sizes: an expected-value problem
# 
