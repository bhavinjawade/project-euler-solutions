...
# -*- coding: utf-8 -*-
'''
    File name: code\constraining_the_least_greatest_and_the_greatest_least\sol_350.py
    Author: Vaidic Joshi
    Date created: Oct 20, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #350 :: Constraining the least greatest and the greatest least
# 
