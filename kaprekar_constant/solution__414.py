...
# -*- coding: utf-8 -*-
'''
    File name: kaprekar_constant\solution__414.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #414 :: Kaprekar constant
# 
