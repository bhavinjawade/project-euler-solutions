...
# -*- coding: utf-8 -*-
'''
    File name: distinct_colourings_of_a_rubiks_cube\solution__599.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #599 :: Distinct Colourings of a Rubik's Cube
# 
