...
# -*- coding: utf-8 -*-
'''
    File name: rolling_ellipse\solution__525.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #525 :: Rolling Ellipse
# 
