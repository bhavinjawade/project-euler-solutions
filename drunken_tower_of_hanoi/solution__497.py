...
# -*- coding: utf-8 -*-
'''
    File name: drunken_tower_of_hanoi\solution__497.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #497 :: Drunken Tower of Hanoi
# 
