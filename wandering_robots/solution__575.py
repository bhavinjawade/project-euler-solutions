...
# -*- coding: utf-8 -*-
'''
    File name: wandering_robots\solution__575.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #575 :: Wandering Robots
# 
