...
# -*- coding: utf-8 -*-
'''
    File name: lambda_count\solution__623.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #623 :: Lambda Count
# 
