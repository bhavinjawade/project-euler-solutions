...
# -*- coding: utf-8 -*-
'''
    File name: a_kempnerlike_series\solution__368.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #368 :: A Kempner-like series
# 
