...
# -*- coding: utf-8 -*-
'''
    File name: square_prime_factors\solution__632.py
    Author: Vaidic Joshi
    Date created: Oct 18, 2018
    Python Version: 3.x
'''

# Solution to Project Euler Problem #632 :: Square prime factors
# 
